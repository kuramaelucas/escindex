...
12. **Figuras das provas.** 298 questões reais (13 da UNIFESP, 32 da Santa Casa, 253 da USP-SP) dependem de uma figura que ainda não foi anexada (lista em `dados/imagens/LEIA-ME.md`). Elas avisam na tela, mas só ficam completas com o recorte do PDF oficial.
...
2. **Anexar as 298 figuras das provas** (`dados/imagens/LEIA-ME.md`): recortar do PDF oficial e salvar com o nome indicado — nada mais precisa mudar.
...
4. **Repetir a carga de provas reais para as outras 3 bancas de referência** (USP-RP/FMRP, IAMSPE, UNESP), se o usuário conseguir os PDFs oficiais. Agora isso é feito **pela própria plataforma**, sem script nem edição do arquivo: a **Central de Provas** (seção 4) cadastra a prova, corta em lotes, dá o modelo pronto de cada faixa e confere o que chegou — e vários lotes podem andar em paralelo.
