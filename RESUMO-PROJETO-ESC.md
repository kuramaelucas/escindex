...
12. **Figuras das provas.** 45 questões reais (13 da UNIFESP, 32 da Santa Casa) dependem de uma figura que ainda não foi anexada (lista em `dados/imagens/LEIA-ME.md`). Elas avisam na tela, mas só ficam completas com o recorte do PDF oficial.
